...
class CreateActivityLogTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('admin_activity_log', function (Blueprint $table) {
            ...
            $table->string('description', 50)->charset('utf8mb3')->default('')->comment('描述');
            $table->string('subject_type', 50)->charset('utf8mb3')->default('')->comment('对象类型');
            $table->bigInteger('subject_id', false, true)->default(0)->comment('对象类型');
            // $table->nullableMorphs('subject', 'subject');
            $table->string('event', 20)->charset('utf8mb3')->nullable()->comment('事件');
            $table->string('causer_type', 50)->charset('utf8mb3')->default('')->comment('操作人员类型');
            $table->integer('causer_id', false, true)->default(0)->comment('操作人员ID');
